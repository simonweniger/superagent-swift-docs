...
export const navigation = [
  ...
  },
  {
    ...
    links: [
      ...
      { title: 'AgentTools', href: '/agent-tools' },
      { title: 'AgentDocuments', href: '/agent-documents' },
    ],
  },
  {
    title: 'Official Superagent links',
    links: [
      { title: 'Official API Docs', href: 'https://docs.superagent.sh' },
      { title: 'Website', href: 'https://superagent.sh' },
      { title: 'Dashboard', href: 'https://app.superagent.sh' },
      { title: 'Superagent Github', href: 'https://github.com/homanp/superagent' },
    ],
  },
]
