...
## Agent Prediction {{ tag: 'POST', label: '/v1/agents{agentId}/predict' }}
    ...
    <Properties>
      ...
      <Property name='PredictAgent(input: "Hello Superagent", hasStreaming: true)' type="Agent Predict Model">
        The updated Agent as a Agent model
      </Property>
    </Properties>
    ...
    let newRequest = PredictAgent(input: "Hello Superagent", hasStreaming: false), hasMemory: true, promptId: "12345678")
